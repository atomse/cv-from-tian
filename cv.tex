...
\newcommand{\arxiv}[1]{preprint: \href{https://arxiv.org/#1}{arxiv.org/#1}}
...
\begin{EntriesTable}
    \Duration{2016}{}  &
    \textbf{PhD in Chemistry}, Tsinghua University, P.R. China
    \\
    \Duration{2012}{2016}  &
    \textbf{BSc in Chemistry}, Tsinghua University, P.R. China
\end{EntriesTable}
...
% \end{EntriesTable}
% 
\subsection*{Preprinted}

\begin{EntriesTable}
\Year{2017}  &
    \Me, \XiaoH, \LiJ.
    Robust and Efficient Chain-of-States Calculations Enabled by Spherical Optimization.
    \arxiv{abs/1904.01924}
\end{EntriesTable}
...
%     \Me, \XiaoH, \LiJ.
%     Robust and Efficient Chain-of-States Calculations Enabled by Spherical Optimization.
%     \href{https://arxiv.org/abs/1904.01924}
% 
% \end{EntriesTable}
...
%     \newline
%     \textit{Instituto Geofı́sico Sismológico Volponi, Universidad Nacional de San Juan}, Argentina.
%     \newline
